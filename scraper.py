...
def _scroll(browser, infinite_scroll, lenOfPage):
    ...
    while not match:
        ...
        if lastCount == lenOfPage:
            print("I am in scroll loop "+ str(lenOfPage) + " last counbt "+ str(lastCount))
...
def extract(page, numOfPost, infinite_scroll=False, scrape_comment=False):
    ...
    print("here i am "+ str(scrape_comment))
    ...
    scrape_comment= True
    if scrape_comment:
        # browser.get("https://www.facebook.com/"+page+"/")
        time.sleep(30)

        moreComments = browser.find_elements_by_xpath('//a[@class="_4sxc _42ft"]')
     
        # moreComments = browser.find_elements_by_xpath('//a[@class="_3hg- _42f"]')
...
if __name__ == "__main__":
    ...
    print(args.page + "lol " +str(args.len) +" lol " + str(scrape_comment) + "  ss "+ str(infinite))
